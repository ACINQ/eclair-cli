...
class DummyEclairClient(
    ...
    private val connectUriResponse: String = validConnectUriResponse,
    private val connectNodeIdResponse: String = validConnectNodeIdResponse,
    ...
    override suspend fun connectUri(uri: String): Either<ApiError, String> = Either.Right(connectUriResponse)
    override suspend fun connectNodeId(nodeId: String): Either<ApiError, String> = Either.Right(connectNodeIdResponse)
    ...
    companion object {
        ...
        val validConnectUriResponse = "connected"
        val validConnectNodeIdResponse = "connected"
        val validDisconnectResponse = "peer 02f666711319435b7905dd77d10c269d8d50c02668b975f526577167d370b50a3e disconnecting"
    }
}
...
class FailingEclairClient(private val error: ApiError) : IEclairClient, IEclairClientBuilder {
    ...
    override suspend fun connectUri(uri: String): Either<ApiError, String> = Either.Left(error)
    override suspend fun connectNodeId(nodeId: String): Either<ApiError, String> = Either.Left(error)
