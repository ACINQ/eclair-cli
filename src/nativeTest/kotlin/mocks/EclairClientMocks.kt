...
class DummyEclairClient(
    ...
    override suspend fun connect(nodeId: String): Either<ApiError, String> = Either.Right(connectResponse)
    companion object {
...
class FailingEclairClient(private val error: ApiError) : IEclairClient, IEclairClientBuilder {
    ...
    override suspend fun connect(nodeId: String): Either<ApiError, String> = Either.Left(error)
