...
class ConnectCommandTest {
    private fun runTest(eclairClient: IEclairClientBuilder, uri: String?, nodeId: String?): DummyResultWriter {
    ...
    fun `successful request via NodeId`() {
        val resultWriter =
            runTest(DummyEclairClient(), null, "02f666711319435b7905dd77d10c269d8d50c02668b975f526577167d370b50a3e")
        assertNull(resultWriter.lastError)
