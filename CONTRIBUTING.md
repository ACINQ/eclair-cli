# Contributing to the eclair-cli project
...
We recommend using our [Github discussions](https://github.com/ACINQ/eclair-cli/discussions).
...
You can also use Github issues for [feature requests](https://github.com/ACINQ/eclair-cli/issues?q=is%3Aissue+label%3A"feature+request").
...
The `eclair-cli` uses [Kotlin Native](https://kotlinlang.org/docs/native-overview.html).
Good understanding of this technology is required to contribute.
...
We try to keep a clean commit history on the master branch with well-formed commit messages.
...
- why you need it
- why you chose this specific library/tool (a thorough analysis of alternatives will be appreciated)
